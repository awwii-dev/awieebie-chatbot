...
# Perbaikan format string agar rapi dan tidak error
SYSTEM_PROMPT = (
...
def kirim():
    ...
    mode_ai = data.get("mode", "santai")  # ← Menerima kiriman mode dari frontend
    ...
    # 💡 FITUR PERSONAL MODE: Menyesuaikan instruksi system prompt sesuai pilihan user
    instruksi_mode = ""
    ...
    # Menggabungkan prompt dasar dengan instruksi mode yang dipilih
